...
export default function Mp4Downloder() {
    ...
    <div className="flex flex-col items-center  bg-[#ffffff]">
      ...
      <div className="  mt-6 flex w-[450px] justify-center   max-md:w-full max-md:justify-around">
        <div className="flex flex-col ">
          ...
          {showDrop && (
            <div
              className={` mt-2 flex flex-col  items-start justify-start ${
                showModal ? "" : ""
              }  `}
            >
              <button
              ...
              <button
                className={`w-full mt-3 block rounded bg-gray-200 px-4 py-2 text-gray-800 hover:text-red-500 ${
              ...
              >
                <a
                  ...
                  //   disabled={true}
                >
                     <AiOutlineDownload className="mr-3 text-2xl"></AiOutlineDownload>
                  {" "}
                  360p
                </a>
              </button>
              <button
                className={`mt-3 block rounded bg-gray-200 px-4 py-2 text-gray-800 hover:text-red-500 ${
              ...
              >
                ...
                className="flex justify-center items-center"
                  ...
                  download={newTitle}
                >
                  <AiOutlineDownload className="mr-3 text-2xl"></AiOutlineDownload> 720p
                </a>
              </button>
              <button
                className={`mt-3 block rounded bg-gray-200 px-4 py-2 text-gray-800 hover:bg-gray-200 ${
